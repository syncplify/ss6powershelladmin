...
function Add-SS6BlockList {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $BlockListItem | ConvertTo-Json
...
function Add-SS6CRTToCSR {
    ...
    Process {
        ...
        if (!$InlineObject3) {
            throw "Error! The required parameter `InlineObject3` missing when calling addCRTToCSR."
        }

        $LocalVarBodyParameter = $InlineObject3 | ConvertTo-Json
...
function Add-SS6Cert {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $TLSCertificate | ConvertTo-Json
...
function Add-SS6LDAPConfig {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $LDAPConfig | ConvertTo-Json
...
function Add-SS6SAML {
    ...
    Process {
        'Calling method: Add-SS6SAML' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/adm/saml'

        if (!$SAMLIdP) {
            throw "Error! The required parameter `SAMLIdP` missing when calling addSAML."
        }

        $LocalVarBodyParameter = $SAMLIdP | ConvertTo-Json
...
function Add-SS6SSHHostKey {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $SSHHostKey | ConvertTo-Json
...
function Add-SS6Script {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $Script | ConvertTo-Json
...
function Add-SS6UserPublicKey {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $SSHPubKey | ConvertTo-Json
...
function Add-SS6VFS {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $VirtualFileSystem | ConvertTo-Json
...
function Invoke-SS6CreateCSR {
    ...
    Process {
        'Calling method: Invoke-SS6CreateCSR' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-SS6DeletePublicKey {
    ...
    Process {
        ...
        $LocalVarUri = $LocalVarUri.replace('{keyID}', $KeyID)
...
.PARAMETER Id
ID of the SAML2.0 IdP

.OUTPUTS

ApiResponse
#>
function Invoke-SS6DeleteSAML {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-SS6DeleteSAML' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/adm/saml/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteSAML."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
...
ApiResponse
#>
function Invoke-SS6GenerateCert {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-SS6GenerateCert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ApiResponse
#>
function Invoke-SS6GenerateSSHHostKey {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-SS6GenerateSSHHostKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarBodyParameter = $HostKeyRequestFields | ConvertTo-Json
...
InlineResponse2003
#>
function Invoke-SS6GenerateUserPublicKeys {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-SS6GenerateUserPublicKeys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-SS6SAML {
    ...
    Process {
        'Calling method: Get-SS6SAML' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/adm/saml/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getSAML."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
...
function Get-SS6SAMLs {
    ...
    Process {
        'Calling method: Get-SS6SAMLs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-SS6ParchVsiteConfig {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $SrvConfig | ConvertTo-Json
...
function Invoke-SS6PatchSAML {
    ...
    Process {
        'Calling method: Invoke-SS6PatchSAML' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/adm/saml/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchSAML."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)

        if (!$SAMLIdP) {
            throw "Error! The required parameter `SAMLIdP` missing when calling patchSAML."
        }
...
function Update-SS6SAML {
    ...
    Process {
        'Calling method: Update-SS6SAML' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/adm/saml/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateSAML."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)

        if (!$SAMLIdP) {
            throw "Error! The required parameter `SAMLIdP` missing when calling updateSAML."
        }
...
function Update-SS6VsiteConfigMode {
    ...
    Process {
        ...
        $LocalVarUri = $LocalVarUri.replace('{mode}', $Mode)
