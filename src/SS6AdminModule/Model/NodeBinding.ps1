...
function Initialize-NodeBinding {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: SS6AdminModule => NodeBinding' | Write-Debug
...
NodeBinding<PSCustomObject>
#>
function ConvertFrom-JsonToNodeBinding {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: SS6AdminModule => NodeBinding' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeBinding
